(function (global, factory) {
	...
	(factory((global.PortalVue = global.PortalVue || {})));
...
function matchURI(pattern, keys, _ref) {
  ...
  return [_extends({}, params, index.parse(search)), match[0]];
}

function compilePath(path, _ref2) {
  var exact = _ref2.exact;

  var keys = [];

  var regex = index$5(path, keys, { end: !!exact });
...
function matchPath(path, _ref3, context) {
  var _ref3$exact = _ref3.exact,
      exact = _ref3$exact === undefined ? false : _ref3$exact;

  if (!path) return [];

  var key = '' + path + exact.toString();

  var _ref4 = cache[key] || compilePath(path, { exact: exact }),
...
var MatchFirst = {
  ...
  render: function render(h) {
    ...
    var vnode = this.$slots.default.find(function (vnode) {
      ...
      return matchPath(path, { exact: exact }, _this.router.location);
    });
...
function injectProps(component, props) {
  var options = component.componentOptions = component.componentOptions || {};
  var propsData = options.propsData = options.propsData || {};
...
var Route = {
  ...
  render: function render(h) {
    var match = matchPath(this.path, { exact: !!this.exact }, this.router.location);
    ...
    var params = _extends$1({}, props, { url: path, path: this.path });
...
var RouterLink = {
  ...
  render: function render(h) {
    ...
    var match = matchPath(this.to, { exact: false }, this.router.location);

    return h('a', {
      class: _defineProperty({}, this.activeClass, !!match),
      on: {
...
var _resolvePathname = index$6;

var _resolvePathname2 = _interopRequireDefault(_resolvePathname);

var _valueEqual = index$8;
...
var ExecutionEnvironment = createCommonjsModule(function (module, exports) {
'use strict';
...
var _createTransitionManager = createTransitionManager_1;

var _createTransitionManager2 = _interopRequireDefault(_createTransitionManager);

var _ExecutionEnvironment = ExecutionEnvironment;
...
var HistoryRouter = {
  ...
  created: function created() {
    ...
    var onLocationChange = function onLocationChange(location) {
      _this.$emit('locationChanged', location);
